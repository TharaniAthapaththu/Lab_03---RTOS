...
String LED_1_State = "off";
String LED_2_State = "off";

static const int LED_1= 5;
static const int LED_2 = 6;
        ...
        if (client.available()) {             // if there's bytes to read from the client,
          ...
          if (c == '\n') {                    // if the byte is a newline character
            ...
            if (currentLine.length() == 0) {
              ...
              client.println("<p>GPIO 5 - State " + LED_1_State + "</p>");
              ...
              client.println("<p>GPIO 6 - State " + LED_2_State + "</p>");
...
void setup() {
  ...
  xTaskCreatePinnedToCore(Task_A, "Task A", 5000, NULL, 1, NULL, 0);
  xTaskCreatePinnedToCore(Task_B, "Task A", 1024, NULL, 1, NULL, 1);
